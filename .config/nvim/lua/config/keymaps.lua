...
map("n", "<leader>g", "<cmd>Git<CR>", { silent = true })
map("n", "<leader>gq", "<cmd>Git<CR>", { silent = true })
...
map("n", "<leader>mn", "<cmd>vnew | wincmd L | vertical resize 50 | set winfixwidth | set nonumber | MemoNew<CR>")
map("n", "<leader>ml", "<cmd>vnew | wincmd L | vertical resize 50 | set winfixwidth | set nonumber | MemoList<CR>")
map("n", "<leader>mg", "<cmd>vnew | wincmd L | vertical resize 50 | set winfixwidth | set nonumber | MemoGrep<CR>")
